...
@file = 12_1
@author = Liangjisheng
@create_time = 2018/5/27 0027 下午 14:55
"""
import math
import random
...
cities = [(-86.75, 33.5666666666667, 'Python'), (-88.25, 30.6833333333333, 'Python'), (-112.016666666667, 33.4333333333333, 'Java'),
          ...
          (-84.4333333333333,33.65,'Python'),(-116.216666666667,43.5666666666667,'Python'),(-87.75,41.7833333333333,'Java'),
          ...
          (-83.0166666666667,42.4166666666667,'Python'),(-84.6,42.7833333333333,'Python'),(-93.2166666666667,44.8833333333333,'Python'),
          (-90.0833333333333,32.3166666666667,'Java'),(-94.5833333333333,39.1166666666667,'Java'),(-90.3833333333333,38.75,'Python'),
          ...
          (-78.7333333333333,42.9333333333333,'R'),(-73.9666666666667,40.7833333333333,'R'),(-80.9333333333333,35.2166666666667,'Python'),
          ...
          (-90,35.05,'R'),(-86.6833333333333,36.1166666666667,'R'),(-97.7,30.3,'Python'),
          (-96.85,32.85,'Java'),(-95.35,29.9666666666667,'Java'),(-98.4666666666667,29.5333333333333,'Java'),
...
plt.legend(loc=0)       # 让matplotlib选择一个位置放置图例
plt.axis([-130, -60, 20, 55])       # 设置坐标轴范围
plt.title('最受欢迎的编程语言')
plt.show()

# 让我们看一下如果尝试利用邻居城市来预测每个城市偏爱的语言会得到什么结果
# 试试多个不同的k值
for k in [1, 3, 5, 7]:
    num_correct = 0
